...
// call getBytecode first, get the bytecode of the contract you want to deploy

//call getAddress and input nonce, to calculate the address of the contract.

// input nonce, and call deploy.
// you can get the same address you predict.